...
void AddDot_8x4_kernel_double(int64_t k, double *a, double *b, double *c, int64_t ldc) {
    ...
    for (i = 0; i < k_blocks; ++i) {
        ...
        // Update pointers
        a += 16;  // Move forward by 16 elements (8 for each iteration)
        b += 8;   // Move forward by 8 elements (4 for each iteration)
    }
    ...
    a0_3b3_ymm = _mm256_permute2f128_pd(tmp_a0_3b_2_ymm, tmp_a0_3b_0_ymm, 0x30);  // 00|11|0000 = 0x30
    
    a0_3b1_ymm = _mm256_permute2f128_pd(tmp_a0_3b_1_ymm, tmp_a0_3b_3_ymm, 0x30);  // 00|11|0000 = 0x30
    a0_3b2_ymm = _mm256_permute2f128_pd(tmp_a0_3b_3_ymm, tmp_a0_3b_1_ymm, 0x30);  // 00|11|0000 = 0x30
    
    a4_7b0_ymm = _mm256_permute2f128_pd(tmp_a4_7b_0_ymm, tmp_a4_7b_2_ymm, 0x30);  // 00|11|0000 = 0x30
    a4_7b3_ymm = _mm256_permute2f128_pd(tmp_a4_7b_2_ymm, tmp_a4_7b_0_ymm, 0x30);  // 00|11|0000 = 0x30
    
    a4_7b1_ymm = _mm256_permute2f128_pd(tmp_a4_7b_1_ymm, tmp_a4_7b_3_ymm, 0x30);  // 00|11|0000 = 0x30
    a4_7b2_ymm = _mm256_permute2f128_pd(tmp_a4_7b_3_ymm, tmp_a4_7b_1_ymm, 0x30);  // 00|11|0000 = 0x30
...
void AddDot_8x4_kernel(int64_t k, TA *a, TB *b, TC *c, int64_t ldc) {
    if constexpr (std::is_same_v<TA, float> && 
        ...
        AddDot_8x4_kernel_float<RM, RN>(k, a, b, c, ldc);
    }
    else if constexpr (std::is_same_v<TA, double> && 
                       std::is_same_v<TB, double> && 
                       std::is_same_v<TC, double>) {
        AddDot_8x4_kernel_double<RM, RN>(k, a, b, c, ldc);
    }
};
