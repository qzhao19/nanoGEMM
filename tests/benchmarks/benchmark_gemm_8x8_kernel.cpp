...
template <typename T>
class GEMM8x8Benchmark {
   public:
    GEMM8x8Benchmark(int64_t m, int64_t n, int64_t k)
    ...
    void run_benchmark() {
        ...
        tinyBLAS::matmul(m_, n_, k_, A_, lda_, B_, ldb_, C_, ldc_, "8x8");
    }
...
static void BM_GEMM(benchmark::State &state) {
    ...
    GEMM8x8Benchmark<T> benchmark(m, n, k);
