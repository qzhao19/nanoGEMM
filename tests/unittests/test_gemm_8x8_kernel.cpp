...
// C(i, j)     C[(j)*ldc + (i)]
template <typename T>
class GEMM8x8KernelTest : public ::testing::Test {
   protected:
    void SetUp() override {
        engine_.seed(42);
        tol_ = 1e-4;
...
TYPED_TEST_SUITE(GEMM8x8KernelTest, TestTypes);
